...
export class Contract extends ethereum.SmartContract {
  ...
  distributionContractAddress(): Address {
  ...
  try_distributionContractAddress(): ethereum.CallResult<Address> {
  ...
  try_distributionContract(): ethereum.CallResult<Address> {
    let result = super.tryCall(
      "distributionContract",
      "distributionContract():(address)",
      []
...
export class ConstructorCall__Inputs {
  ...
  get _distributionContract(): Address {
    return this._call.inputValues[0].value.toAddress();
  }
}
